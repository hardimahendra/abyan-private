...
import Sejarah from '../components/modal/Sejarah';
import Jenjang from '../components/modal/Jenjang';
import Layanan from '../components/modal/Layanan';
import Kenyamanan from '../components/modal/Kenyamanan';
    ...
    const [kenyamanan, setKenyamanan] = useState(false);
        ...
        <div className="container-profil">
            ...
            <div className="layanan-keunggulan">
                <h3>Layanan & Keunggulan Abyan Private</h3>
